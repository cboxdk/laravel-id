...
The engineering posture is documented in [`docs/security/`](docs/security/_index.md) and
the RFC/standard conformance in [`docs/security/standards.md`](docs/security/standards.md). In short:
...
- **A published conformance matrix** ([`docs/security/standards.md`](docs/security/standards.md))
