...
- [Cookbook](../cookbook/_index.md) — the reconcile snippet in context, plus RBAC and SSO.
- [Integrating an existing app](../cookbook/integrating-existing-apps.md) — adopt over an app that already has users and billing.
- [Security](../security/_index.md) — how entitlement writes are tenant-scoped and audited.
